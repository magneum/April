...
module.exports = {
  ...
  execute(message, args) {
    ...
    if (!queue) return message.channel.send(pnoir.__("remove.ɴᴏɪʀ_error_Not_Queue")).catch(console.error);
    if (!canModifyQueue(message.member)) return pnoir.__("common.ɴᴏɪʀ_error_NotChannel");
    if (!args.length) return message.reply(pnoir.__mf("remove.ɴᴏɪʀ_usage_Reply", { prefix: message.client.prefix }));
