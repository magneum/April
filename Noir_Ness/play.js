...
const { play } = require("../Noir_YouTube/play");
...
if (!channel) return message.reply(pnoir.__("play.ɴᴏɪʀ_error_NotChannel")).catch(console.error);
...
if (!permissions.has("CONNECT")) return message.reply(pnoir.__("play.ɴᴏɪʀ_missing_Permission_Connect"));
if (!permissions.has("SPEAK")) return message.reply(pnoir.__("play.ɴᴏɪʀ_missing_Permission_Speak"));
